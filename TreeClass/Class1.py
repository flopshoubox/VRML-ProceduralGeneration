...
class Class1:
    ...
    spineTrunk = [0,0,0,0,0.5,0,0,1,0,0,1.5,0,0,2,0,0,2.5,0,0,3,0,0,3.5,0,0,4,0,0,4.5,0,0,5,0] #3
    scaleTrunk = [0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5] #2
    ...
    def toString(self):
        ...
        for z in range(0,m):
            ...
            stri += "\t\t\t\t\t\t\t\t\t\t\t\t\t\tpoint [\n"
            stri += listStr(tempLeaf,14, 3) + "]\n"
            stri += "\t\t\t\t\t\t\t\t\t\t\t\t\t}\n"
            stri += "\t\t\t\t\t\t\t\t\t\t\t\t\tcoordIndex [\n"
            stri += listStr(self.coordIndexLeaf, 13, 4) + "]\n"
            stri += "\t\t\t\t\t\t\t\t\t\t\t\t}\n"
            stri += "\t\t\t\t\t\t\t\t\t\t\t}\n"
            stri += "\t\t\t\t\t\t\t\t\t\t]\n"
            stri += "\t\t\t\t\t\t\t\t\t}\n"
            ...
            stri += "\t\t\t\t\t\t\t\t\t\t\tccw TRUE\n"
            stri += "\t\t\t\t\t\t\t\t\t\t\tspine [\n"
            stri += listStr(tempSpineTrunk, 11, 3) + "]\n"
            stri += "\t\t\t\t\t\t\t\t\t\t\tscale [\n"
            stri += listStr(self.scaleTrunk, 11, 2) + "]\n"
            stri += "\t\t\t\t\t\t\t\t\t\t\tcrossSection [\n"
            stri += listStr(self.crossSection, 11, 2) + "]\n"
            stri += "\t\t\t\t\t\t\t\t\t\t}\n"
            stri += "\t\t\t\t\t\t\t\t\t}\n"
        ...
        stri += "\t\t\t\t\t\t\t\t\tcrossSection [\n"
        stri += listStr(self.crossSection, 9, 2) + "]\n"
        stri += "\t\t\t\t\t\t\t\t}\n"
        stri += "\t\t\t\t\t\t\t}\n"
        stri += "\t\t\t\t\t\t]\n"
        stri += "\t\t\t\t\t}"
